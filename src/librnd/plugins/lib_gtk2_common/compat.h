...
#define gtkc_paned_pack1(pane, ch, resiz) gtk_paned_pack1(GTK_PANED(pane), ch, resiz, FALSE)
#define gtkc_paned_pack2(pane, ch, resiz) gtk_paned_pack2(GTK_PANED(pane), ch, resiz, FALSE)
...
#define gtkc_unbind_mouse_btn(w, sig) g_signal_handler_disconnect(G_OBJECT(w), sig)
...
#define gtkc_unbind_key(w, sig)  g_signal_handler_disconnect(w, sig)
