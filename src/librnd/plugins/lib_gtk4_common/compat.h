...
#define gtkc_combo_box_get_entry(combo)  gtk_combo_box_get_child(GTK_COMBO_BOX(combo))
...
#	define gtkc_bind_mouse_press(widget, ev) \
		g_signal_connect(G_OBJECT(gtkc_evctrl_click(widget)), "pressed", G_CALLBACK(gtkc_mouse_press_cb), ev);

#	define gtkc_bind_mouse_release(widget, ev) \
		g_signal_connect(G_OBJECT(gtkc_evctrl_click(widget)), "released", G_CALLBACK(gtkc_mouse_release_cb), ev);
#else
#	define gtkc_bind_mouse_press(widget, ev) \
		g_signal_connect(G_OBJECT(gtkc_evctrl_click(widget)), "event", G_CALLBACK(gtkc_mouse_press_cb), ev);

#	define gtkc_bind_mouse_release(widget, ev) \
		g_signal_connect(G_OBJECT(gtkc_evctrl_click(widget)), "event", G_CALLBACK(gtkc_mouse_release_cb), ev);
#endif
