...
BEGIN {
	...
	print "/******************************************************************************"
	print " Auto-generated by librnd/plugins/map_plugins.sh - do NOT edit,"
	print " run make map_plugins in trunk/src/ - to change any of the data below,"
	print " edit librnd/plugins/PLUGIN/PLUGIN.pup"
	print "******************************************************************************/"
}
...
$PUPLUG findpups . "include {../src/librnd/plugins/%D/Plug.tmpasm}\n" | sort >> plugins_ALL.tmpasm
