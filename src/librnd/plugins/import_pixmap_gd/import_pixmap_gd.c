...
static int gd_load(rnd_design_t *hidlib, rnd_pixmap_t *pxm, const char *fn, gdImagePtr (*loader)(FILE *f))
{
	int x, y;
	gdImagePtr gdi;
	FILE *f;
...
static int gd_png_load(rnd_design_t *hidlib, rnd_pixmap_t *pxm, const char *fn)
{
...
static int gd_jpg_load(rnd_design_t *hidlib, rnd_pixmap_t *pxm, const char *fn)
{
...
static int gd_gif_load(rnd_design_t *hidlib, rnd_pixmap_t *pxm, const char *fn)
{
