...
typedef enum {
	...
	RND_EVENT_DAD_NEW_PANE_GEO,       /* [3.2.0] called by the GUI after the pane geometry _may_ have changed; args are: void *hid_ctx, const char *dialog id, const char *pane id, double ratio */
